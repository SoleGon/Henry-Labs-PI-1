...
async def startup():
    global data         ## leo el csv normalizadado desde mi GitHub
    data = pd.read_csv('https://raw.githubusercontent.com/SoleGon/Henry-Labs-PI-1/main/peliculasyseries.csv') 
...
async def get_word_count( palabra:str,nombre_plataforma: str):## los parametros son la plataforma y la palabra
    ...
    elif  nombre_plataforma== 'hulu':## si la plataforma es amazon
